...
class userController{
  ...
  async getProfile(req, res){
    try {
      const user = await User.findOne({ username: req.params.username }).select("-password ").select("id username bio createdAt avatar rank points favoriteDriver favoriteTeam");
      if(!user){
      ...
      const { id, username, bio, createdAt, avatar, rank, points, favoriteDriver, favoriteTeam } = user;
